...
public class MenuButton extends JButton {
	...
	MenuButton(String menuName, String imgPath, int price, int kCal) {
		this.MENU_NAME = menuName;
		this.IMG_PATH = imgPath;
		this.PRICE = price;
		this.K_CAL = kCal;
		
		this.setText("<html><center>" + menuName + "<br>" + (LangCheck.isKorean() ? "가격 ₩ " : "Price ₩ ")
		...
		this.addActionListener(new ActionListener() {
			...
			public String toString() {
				return new StringBuilder().append(menuName).append(LangCheck.isKorean() ? "||가격 ₩" : "||Price ₩")
