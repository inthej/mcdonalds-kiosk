...
class OrderTitlePanel extends JPanel {
    ...
    private static final JLabel MENU_LABEL = new JLabel(LangCheck.isKorean() ? "메뉴" : "MENU",
            JLabel.CENTER);
    private static final JLabel QUANTITY_LABEL = new JLabel(LangCheck.isKorean() ? "수량" : "QUANTITY",
            JLabel.CENTER);
    private static final JLabel PRICE_LABEL = new JLabel(LangCheck.isKorean() ? "가격" : "PRICE",
            JLabel.CENTER);
