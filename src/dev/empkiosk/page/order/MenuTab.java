...
public class MenuTab extends JTabbedPane {
    ...
    private void resisterBurger() {
        ...
        burgerTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "맥스파이시™ 상하이 버거" : "McSpicy™ Shanghai Burger", 4900,
                        463)));
        burgerTable.addMenu(new MenuButton(
                "image/burger/1955 Burger™.png",
                new OrderData(LangCheck.isKorean() ? "1955 버거™" : "1955 Burger™", 5900,
                        509)));
        burgerTable.addMenu(new MenuButton(
        ...
        burgerTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "쿼터파운더™ 치즈" : "Quarter Pounder® with Cheese", 5400,
                        496)));
        burgerTable.addMenu(new MenuButton(
        ...
        burgerTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "불고기 버거" : "Bulgogi Burger", 2500,
                        398)));
        burgerTable.addMenu(new MenuButton(
        ...
        burgerTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "치킨 버거" : "Chicken Burger", 2500,
                        324)));
        burgerTable.addMenu(new MenuButton(
                "image/burger/Cheeseburger.png",
                new OrderData(LangCheck.isKorean() ? "치즈버거" : "Cheeseburger", 3000,
                        302)));
        burgerTable.addMenu(new MenuButton(
    ...
    private void resisterSnack() {
        ...
        snackTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "스파이시 비프 스낵랩®" : "Spicy Beef Snack Wrap®", 2500,
                        297)));
        snackTable.addMenu(new MenuButton(
    ...
    private void resisterSetMenu() {
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "골든 에그 치즈버거 세트" : "Golden Egg Cheeseburger Meal", 9700,
                        1004)));
        setMenuTable.addMenu(new MenuButton(
                "image/set_menu/prol_201703290425447840.png",
                new OrderData(LangCheck.isKorean() ? "그릴드 머쉬룸 버거 세트" : "Grilled Mushroom Burger Meal", 9700,
                        1047)));
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(
                        ...
                        988)));
        setMenuTable.addMenu(new MenuButton(
                "image/set_menu/prol_201402210535304330.png", new OrderData(LangCheck.isKorean() ? "빅맥® 세트"
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "맥스파이시™ 상하이 버거 세트"
                        : "<html><center>McSpicy™ Shanghai Burger<br>Extra Value Meal</center></html>", 6300,
                        831)));
        setMenuTable.addMenu(new MenuButton(
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "더블 1955 버거™ 세트"
                        : "<html><center>Double 1955 Burger™<br>Extra Value Meal</center></html>", 8800,
                        1094)));
        setMenuTable.addMenu(new MenuButton(
                "image/set_menu/prol_201312021239276890.png",
                new OrderData(LangCheck.isKorean() ? "쿼터파운더™ 치즈 세트"
                        : "<html><center>Quarter Pounder® with Cheese<br>Extra Value Meal</center></html>",
                        7100,
                        864)));
        setMenuTable.addMenu(new MenuButton(
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "베이컨 토마토 디럭스™ 세트"
                        : "<html><center>Bacon Tomato Deluxe™<br>Extra Value Meal</center></html>", 7400,
                        887)));
        setMenuTable.addMenu(new MenuButton(
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "더블 불고기 버거 세트"
                        : "<html><center>Double Bulgogi Burger<br>Extra Value Meal</center></html>", 6300,
                        1014)));
        setMenuTable.addMenu(new MenuButton(
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "맥스파이시™ 치킨 텐더 세트"
                        : "<html><center>McSpicy™ Chicken Tenders<br>Extra Value Meal</center></html>", 6400,
                        728)));
    }
    ...
    private void resisterMcCafe() {
        mcCafeTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "프리미엄 로스트™ 원두커피" : "Premium Roast™ Coffee", 1500,
                        10)));
        mcCafeTable.addMenu(new MenuButton(
        ...
        mcCafeTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "아이스 카라멜 마키아또" : "Iced Caramel Macchiato", 2900,
                        187)));
        mcCafeTable.addMenu(new MenuButton(
                "image/mc_cafe/prol_201704210613038480.png",
                new OrderData(LangCheck.isKorean() ? "애플 망고 요거트 스무디" : "Apple Mango Yogurt Smoothie", 3800,
                        264)));
        mcCafeTable.addMenu(new MenuButton(
        ...
        mcCafeTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "피콜로" : "Piccolo", 2800,
                        76)));
        mcCafeTable.addMenu(new MenuButton(
    ...
    private void resisterMcLunch() {
        mcLunchTable.addMenu(new MenuButton(
                ...
                new OrderData(
                        ...
                        988)));
        mcLunchTable.addMenu(new MenuButton(
                "image/mc_lunch/prol_201402210535304330.png", new OrderData(LangCheck.isKorean() ? "빅맥® 세트"
                : "<html><center>Big Mac®<br>Extra Value Meal</center></html>", 4900, 880)));
        mcLunchTable.addMenu(new MenuButton(
                "image/mc_lunch/prol_201312021239480850.png",
                new OrderData(LangCheck.isKorean() ? "맥스파이시™ 상하이 버거 세트"
                        : "<html><center>McSpicy™ Shanghai Burger<br>Extra Value Meal</center></html>", 4900,
                        831)));
        mcLunchTable.addMenu(new MenuButton(
        ...
        mcLunchTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "베이컨 토마토 디럭스™ 세트"
                        : "<html><center>Bacon Tomato Deluxe™<br>Extra Value Meal</center></html>", 5500,
                        887)));
        mcLunchTable.addMenu(new MenuButton(
        ...
        mcLunchTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "더블 불고기 버거 세트"
                        : "<html><center>Double Bulgogi Burger<br>Extra Value Meal</center></html>", 4900,
                        1014)));
    }
    ...
    private void resisterDrink() {
        ...
        drinkTable.addMenu(new MenuButton(
                "image/drink/prol_201312050152466340.png",
                new OrderData(LangCheck.isKorean() ? "스프라이트" : "Sprite", 1500,
                        149)));
        drinkTable.addMenu(new MenuButton(
                "image/drink/prol_201312050152466340.png",
                new OrderData(LangCheck.isKorean() ? "환타" : "Fanta", 1500,
                        167)));
        drinkTable.addMenu(new MenuButton(
    ...
    private void resisterMcMoning() {
        mcMoningTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "토마토 베이컨 에그 맥머핀™" : "Tomato Bacon Egg McMuffin™", 4800,
                        448)));
        mcMoningTable.addMenu(new MenuButton(
        ...
        mcMoningTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "토마토 베이컨 에그 맥머핀™ 세트"
                        : "<html><center>Tomato Bacon Egg McMuffin™<br>Extra Value Breakfast</center></html>",
                        4800,
                        448)));
        mcMoningTable.addMenu(new MenuButton(
        ...
        mcMoningTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "베이컨 에그 맥머핀™ 세트"
                        : "<html><center>Bacon Egg McMuffin™<br>Extra Value Breakfast</center></html>", 4300,
                        454)));
        mcMoningTable.addMenu(new MenuButton(
                "image/mc_moning/prol_201501280444463940.png",
                new OrderData(LangCheck.isKorean() ? "소시지 맥머핀™ 세트"
                        : "<html><center>Sausage McMuffin™<br>Extra Value Breakfast</center></html>", 4200,
                        504)));
        mcMoningTable.addMenu(new MenuButton(
        ...
        mcMoningTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "치킨 치즈 머핀 세트"
                        : "<html><center>Chicken 'n Cheese Muffin<br>Extra Value Breakfast</center></html>",
                        4600,
                        503)));
        mcMoningTable.addMenu(new MenuButton(
                "image/mc_moning/prol_201501280446555460.png",
                new OrderData(LangCheck.isKorean() ? "디럭스 브렉퍼스트™ 세트"
                        : "<html><center>Deluxe Breakfast™<br>Extra Value Breakfast</center></html>", 6300,
                        826)));
        mcMoningTable.addMenu(new MenuButton(
    ...
    private void resisterDessert() {
        ...
        dessertTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "츄러스" : "Churros", 2000,
                        181)));
        dessertTable.addMenu(new MenuButton(
        ...
        dessertTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "딸기 오레오 맥플러리®" : "Strawberry Oreo McFlurry®", 3000,
                        291)));
        dessertTable.addMenu(new MenuButton(
