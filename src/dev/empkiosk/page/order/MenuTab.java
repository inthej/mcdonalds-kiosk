...
public class MenuTab extends JTabbedPane {
    ...
    private void resisterSetMenu() {
        ...
        setMenuTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "크리스피 오리엔탈 치킨버거 세트" : "Crispy Oriental Chicken Burger Meal",
                        7100, 988)));
        setMenuTable.addMenu(new MenuButton(
    ...
    private void resisterMcCafe() {
        ...
        mcCafeTable.addMenu(new MenuButton(
                ...
                new OrderData(LangCheck.isKorean() ? "블루베리 석류 요거트 스무디" : "Blueberry Pomegranate Yogurt Smoothie",
                        3800, 222)));
        mcCafeTable.addMenu(new MenuButton(
