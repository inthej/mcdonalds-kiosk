...
public class ConfirmPage extends KioskPage {
	...
	private final OrderTotalDataPanel ORDER_TOTAL_LIST_PANEL = new OrderTotalDataPanel(EatPlace.EAT_IN, array);
	...
	private void initOrderTotalListPanel() {
		...
		orderConfirmGuideComp.setLocation((KioskPage.PAGE_WIDTH - MIDDLE_PANEL_WIDTH) / 2, KioskPage.PAGE_HEIGHT / 4);
	...
	private void initYesNoSelectPanel() {
		...
		yesNoSelectComp.setLocation((KioskPage.PAGE_WIDTH - PANEL_WIDTH) / 2, KioskPage.PAGE_HEIGHT * 3 / 4);
