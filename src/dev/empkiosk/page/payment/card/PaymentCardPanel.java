...
class PaymentCardPanel extends JPanel {	
	...
	private void initImageLabel() {
		IMAGE_LABEL.setIcon(ImageEdit.getResizeIcon("image/insert_card.jpg", LABEL_IMG_SIZE_WIDTH, LABEL_IMG_SIZE_HEIGHT));
	...
	private void initImageTextButton() {
		...
		IMAGE_TEXT_BUTTON.setResizedImg(new ImageIcon("image/card.png"), BUTTON_IMG_SIZE_WIDTH, BUTTON_IMG_SIZE_HEIGHT);
