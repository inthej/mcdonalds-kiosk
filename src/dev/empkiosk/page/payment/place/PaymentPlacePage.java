...
public class PaymentPlacePage extends KioskPage {
	...
	private final KioskGuidePanel PAYMENT_SELECT_PANEL = new KioskGuidePanel(LangCheck.isKorean() ? "어디에서 지불하시겠습니까?" : "WHERE DO YOU WANT TO PAY?", 0, 2);
	...
	private void initKioskButton() {
		...
		CARD_BUTTON.setText("<html><center>" + (LangCheck.isKorean() ? "바로 결제<br>(카드 가능)" : "DIRECT PAYMENT IN KIOSK<br>(CARD)")
				+ "</center></html>");
