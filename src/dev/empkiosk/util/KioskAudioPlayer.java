...
/**
 * @author mommoo <p> Kiosk 컴포넌트의 오디오 요소를 담당하는 클래스이다. 이미 재생한 오디오 목록은 자체적으로 저장 해놓는다. <p> 사용자가 이미 재상한
 *         오디오를 호출할 시, 캐시 데이터를 이용하여 자원의 효율성을 높인다. <p> 사용자는 단순히 플레이어 재생, 플레이어 정지를 이용하면 된다.
 * @version 1.0v
 * @since 2017. 05. 31.
 */
