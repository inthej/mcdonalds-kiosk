...
public class McCafeTable extends MenuTable {
  ...
  public McCafeTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterMcCafe(orderDataModel);
  }

  private void resisterMcCafe(final OrderDataModel orderDataModel) {
    this.addMenu(
