...
public class SetMenuTable extends MenuTable {
  ...
  public SetMenuTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterSetMenu(orderDataModel);
  }

  private void resisterSetMenu(final OrderDataModel orderDataModel) {
    this.addMenu(
