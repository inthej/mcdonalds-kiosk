...
public class SetMenuTable extends MenuTable {
  ...
  public SetMenuTable(MenuPage menuPage, final OrderData orderData, final int rows, final int cols) {
    super(rows, cols);
    resisterSetMenu(menuPage, orderData);
  }

  private void resisterSetMenu(MenuPage menuPage, final OrderData orderData) {
    this.addMenu(
