...
public class McLunchTable extends MenuTable {
  ...
  public McLunchTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterMcLunch(orderDataModel);
  }

  private void resisterMcLunch(final OrderDataModel orderDataModel) {
    this.addMenu(
