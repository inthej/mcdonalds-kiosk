...
public class McLunchTable extends MenuTable {
  ...
  public McLunchTable(MenuPage menuPage, final OrderData orderData, final int rows, final int cols) {
    super(rows, cols);
    resisterMcLunch(menuPage, orderData);
  }

  private void resisterMcLunch(MenuPage menuPage, final OrderData orderData) {
    this.addMenu(
