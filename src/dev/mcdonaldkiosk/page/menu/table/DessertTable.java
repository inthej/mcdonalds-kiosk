...
public class DessertTable extends MenuTable {
  ...
  public DessertTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterDessert(orderDataModel);
  }

  private void resisterDessert(final OrderDataModel orderDataModel) {
    this.addMenu(
