...
public class McMoningTable extends MenuTable {
  ...
  public McMoningTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterMcMoning(orderDataModel);
  }

  private void resisterMcMoning(final OrderDataModel orderDataModel) {
    this.addMenu(
