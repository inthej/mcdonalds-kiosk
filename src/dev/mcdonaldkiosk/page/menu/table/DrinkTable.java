...
public class DrinkTable extends MenuTable {
  ...
  public DrinkTable(final OrderDataModel orderDataModel, final int rows, final int cols) {
    super(rows, cols);
    resisterDrink(orderDataModel);
  }

  private void resisterDrink(final OrderDataModel orderDataModel) {
    this.addMenu(
